...
@dataclass()
class StaticButtonCreateInfo(ButtonCreateInfo, StaticImageCreateInfo):
    pass


class StaticButton(ButtonType, StaticImage):
    # Basic functional button class
    def __init__(self, info: Union[type[StaticButtonCreateInfo]]):
        StaticImage.__init__(self, info)
